...
<div class="container px-4 py-5" id="custom-cards">
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-5">
            <h2 class="display-5 fw-bold"><?= e($heroSubtitle) ?></h2>
            <p class="col-md-8 fs-4"><?= e($heroDescription) ?></p>
        </div>
    </div>
        ...
        <div class="col">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    ...
                    <h3 class="mt-3 mb-4 display-6 lh-1 fw-bold text-center"><?= e($cardDocsTitle) ?></h3>
                    <ul class="d-flex list-unstyled mt-auto">
                        <li class="me-auto">
                            <small><?= e($cardDocsText) ?></small>
                        </li>
                        <li class="d-flex align-items-center ms-3">
                            <a href="//phplitecore/demo-docs/documentation.html" class="btn btn-outline-light btn-sm"><?= e($cardDocsButton) ?></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card card-cover h-100 overflow-hidden text-bg-secondary rounded-4 shadow-lg">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    ...
                    <h3 class="mt-3 mb-4 display-6 lh-1 fw-bold text-center"><?= e($cardCodeTitle) ?></h3>
                    <ul class="d-flex list-unstyled mt-auto">
                        <li class="me-auto">
                            <small><?= e($cardCodeText) ?></small>
                        </li>
                        <li class="d-flex align-items-center ms-3">
                        </li>
                    </ul>
        ...
        <div class="col">
            <div class="card card-cover h-100 overflow-hidden text-bg-primary rounded-4 shadow-lg">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                    ...
                    <h3 class="mt-3 mb-4 display-6 lh-1 fw-bold text-center"><?= e($cardCommunityTitle) ?></h3>
                    <ul class="d-flex list-unstyled mt-auto">
                        <li class="me-auto">
                            <small><?= e($cardCommunityText) ?></small>
                        </li>
                        <li class="d-flex align-items-center ms-3">
                            <a href="https://github.com/MuhammadAdelA/phpLiteCore" class="btn btn-outline-light btn-sm" target="_blank"><?= e($cardCommunityButton) ?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <p class="text-muted text-center mt-5"><small><?= e($versionLabel) ?> 1.0.0 (Example)</small></p>
